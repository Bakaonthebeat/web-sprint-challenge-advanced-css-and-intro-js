...
its having the extra things there for people who might need them on your website.
2. Talk about 3 different things you can do to ensure your website is accessible.
mobile friendly, Screen reader, Magnify 
3. How would you explain the concept of a variable to someone new to programming?
its just like in math when we substitute number for a letter. we are saying x can be whatever we want it to be 
4. What is the purpose of using functions in code?

Peices of code that can be call upon to do a specfic job.
making it easier to parse out data and read it.
