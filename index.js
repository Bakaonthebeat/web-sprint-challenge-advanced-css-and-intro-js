...
for ( let item of array ){
  if(item.years.substring(0,4)>=1900 &&item.years.substring(6)<=2000) {

cent20.push(item.name)
...
function addArtist(artists){
 ...
 artists.push( {
    ...
    "bio":"Recieved his first computer when he was three years old."
  })
  return artists
